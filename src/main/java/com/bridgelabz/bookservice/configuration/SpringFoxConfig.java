package com.bridgelabz.bookservice.configuration;
...
public class SpringFoxConfig implements WebMvcConfigurer {
   ...
   public Docket api() {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.bookservice.controller"))
   ...
   /*private ApiInfo getApiInfo() {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfo("BookService",
                ...
                new Contact("BookService", "http://bridgelabz.bookservice", "himanshi1252@gmail.com"),
